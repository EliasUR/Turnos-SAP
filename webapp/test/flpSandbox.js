		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ER - Turnos",
									"targetURL": "#comsofttekaca2024er-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsofttekaca2024er-display": {
								"semanticObject": "comsofttekaca2024er",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.softtek.aca2024er",
									"url": sap.ui.require.toUrl("com/softtek/aca2024er")
								}
							}
						}
					}
